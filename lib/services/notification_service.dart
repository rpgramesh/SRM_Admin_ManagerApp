...
class NotificationService {
  ...
  Future<void> notifyShiftAssigned({required String staffId, required Shift shift}) async {
    await _createNotificationRecord(
      type: NotificationType.restaurant,
      title: 'Shift Assigned',
      message: 'You are assigned: ${shift.role} ${_fmtTime(shift.startTime)}-${_fmtTime(shift.endTime)}',
      orderId: null,
      routeId: null,
    );
  }

  Future<void> notifyShiftUpdated({required String staffId, required Shift shift}) async {
    await _createNotificationRecord(
      type: NotificationType.restaurant,
      title: 'Shift Updated',
      message: 'Shift updated: ${shift.role} ${_fmtTime(shift.startTime)}-${_fmtTime(shift.endTime)}',
      orderId: null,
      routeId: null,
    );
  }
